...
public class DragonBorn extends Character{
    ...
    System.out.println("1. Skill 1(Clipboard): Max Damage: " + (getAttack() + 15) + " | Energy cost: 30 | Cooldown 2 round");
    System.out.println("2. SKill 2(Friendship Punch): Max Damage: " + (getAttack() + 20) + " | Energy cost: 20 | Cooldown 3 round");
    System.out.println("3. Skill 3(Trashtalk): Max Damage: " + (getAttack() + 30) + " | Energy cost: 20 | Cooldown 3 rounds");
    System.out.println();
    }
    ...
    public void useSkill1(Enemy enemy) {
        ...
        System.out.println(getName() + " used Clipboard! Damage is " + dmg);
    ...
    public void useSkill2(Enemy enemy) {
        ...
        System.out.println(getName() + " used Friendship Punch! Damage is " + dmg);
        enemy.takeDamage(dmg + getAttack());
    ...
    public void useSkill3(Enemy enemy) {
        ...
        setCurrentEnergy(getCurrentEnergy() - 20);
        System.out.println(getName() + " used Trashtalk! Damage is " + dmg);
        enemy.takeDamage(dmg + getAttack());
